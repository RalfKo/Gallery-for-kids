...
## [Unreleased]
### Added
- Added password protection for included folder visibility, shared with excluded folder management ("Gallery Kids" fork)
- Added arm64-v8a-only debug build workflow
